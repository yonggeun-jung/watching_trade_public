...
def main():
    ...
    parser.add_argument('--ports-file', type=str, default='watching_trade/data/raw/target_ports.csv')
    parser.add_argument('--output', type=str, default='watching_trade/data/raw/sar_ports.csv')
