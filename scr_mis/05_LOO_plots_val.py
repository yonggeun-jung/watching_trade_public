...
# File paths
PRED_PORT_PATH = "watching_trade/output_tables/08_02_xgb_predictions_LOO_val_ports.csv"
PRED_NOPORT_PATH = "watching_trade/output_tables/09_02_xgb_predictions_LOO_val_noports.csv"
...
for port in ports:
    ...
    plt.tight_layout()
    plt.savefig(f'{OUTPUT_DIR}/LOO_timeseries_val_{port_filename}.pdf', bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'{OUTPUT_DIR}/LOO_error_port_val_{port_filename}.pdf', bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'{OUTPUT_DIR}/LOO_error_noport_val_{port_filename}.pdf', bbox_inches='tight')
    plt.close()
