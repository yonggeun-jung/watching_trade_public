...
metrics_df.to_csv("watching_trade/output_tables/06_01_xgb_metrics_LOO_wgt_ports.csv", index=False)
...
pred_df.to_csv("watching_trade/output_tables/06_02_xgb_predictions_LOO_wgt_ports.csv", index=False)
...
importance_df.to_csv("watching_trade/output_tables/06_03_xgb_importance_LOO_wgt_ports.csv", index=False)

print(f"\nFeature Importance:")
print(importance_df)

# Model save
joblib.dump(model, "watching_trade/output_models/05_xgb_model_LOO_wgt_ports.joblib")
