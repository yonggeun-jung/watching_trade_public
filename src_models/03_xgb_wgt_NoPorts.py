...
# Save metrics
pd.DataFrame([metrics]).to_csv("watching_trade/output_tables/03_01_xgb_metrics_wgt_noports.csv", index=False)
...
result_df.to_csv("watching_trade/output_tables/03_02_xgb_predictions_wgt_noports.csv", index=False)
...
importance_df.to_csv("watching_trade/output_tables/03_03_xgb_importance_wgt_noports.csv", index=False)

print(f"\nFeature Importance (Top 15):")
print(importance_df.head(15))

# Save model and encoders
joblib.dump(model, "watching_trade/output_models/02_xgb_model_wgt_noports.joblib")
joblib.dump(label_encoders, "watching_trade/output_models/02_xgb_encoders_wgt_noports.joblib")
