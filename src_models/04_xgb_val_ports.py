...
# Save metrics
pd.DataFrame([metrics]).to_csv("watching_trade/output_tables/04_01_xgb_metrics_val_ports.csv", index=False)
...
result_df.to_csv("watching_trade/output_tables/04_02_xgb_predictions_val_ports.csv", index=False)
...
importance_df.to_csv("watching_trade/output_tables/04_03_xgb_importance_val_ports.csv", index=False)

print(f"\nFeature Importance (Top 15):")
print(importance_df.head(15))

# Save model and encoders
joblib.dump(model, "watching_trade/output_models/03_xgb_model_val_ports.joblib")
joblib.dump(label_encoders, "watching_trade/output_models/03_xgb_encoders_val_ports.joblib")
