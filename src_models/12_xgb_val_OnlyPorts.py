...
# Save metrics
pd.DataFrame([metrics]).to_csv("watching_trade/output_tables/14_01_xgb_metrics_val_OnlyPorts.csv", index=False)
...
result_df.to_csv("watching_trade/output_tables/14_02_xgb_predictions_val_OnlyPorts.csv", index=False)
...
importance_df.to_csv("watching_trade/output_tables/14_03_xgb_importance_val_OnlyPorts.csv", index=False)

print(f"\nFeature Importance (Top 15):")
print(importance_df.head(15))

# Save model and encoders
joblib.dump(model, "watching_trade/output_models/11_xgb_model_val_OnlyPorts.joblib")
joblib.dump(label_encoders, "watching_trade/output_models/11_xgb_encoders_val_OnlyPorts.joblib")
