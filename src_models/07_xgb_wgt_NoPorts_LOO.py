...
metrics_df.to_csv("watching_trade/output_tables/07_01_xgb_metrics_LOO_wgt_noports.csv", index=False)
...
pred_df.to_csv("watching_trade/output_tables/07_02_xgb_predictions_LOO_wgt_noports.csv", index=False)
...
importance_df.to_csv("watching_trade/output_tables/07_03_xgb_importance_LOO_wgt_noports.csv", index=False)

print(f"\nFeature Importance:")
print(importance_df)

# Model save
joblib.dump(model, "watching_trade/output_models/06_xgb_model_LOO_wgt_noports.joblib")
